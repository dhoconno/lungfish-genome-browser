...
|---|---|---|---|---|---|---|
| 1 | 01-foundations/01-what-is-a-genome | What Is a Genome | [] | hbb-gene | existing | queued |
| 2 | 01-foundations/02-sequencing-reads | Sequencing Reads | [] | hg002-chr20, hg002-long-reads | existing | queued |
| 3 | 01-foundations/03-amplicon-vs-shotgun | Amplicons and Shotgun Sequencing | [] | hg002-chr20, Williams project | existing | queued |
...
| 11 | 02-sequences/03-extracting-and-comparing | Extracting and Comparing | [] | hbb-gene | existing | queued |
| 12 | 02-sequences/04-aligning-sequences | Aligning Sequences | [msa.mafft, msa.view, msa.export, import.msa] | primate-mito | new (split from 04-msa-and-trees) | queued |
...
| 14 | 03-reads/01-importing-fastq | Importing FASTQ | [import.fastq, import.fastq-sample-sheet] | hg002-chr20 | existing | queued |
...
| 24 | 04-alignments/03-primer-trimming | Primer Trimming | [bam.primer-trim] | sarscov2-srr36291587 | existing | queued |
...
| 33 | 06-classification/02-running-kraken2 | Running Kraken 2 | [classify.kraken2, classify.install-database, classify.taxonomy-browser, classify.extract-reads-by-taxon] | sarscov2-srr36291587 | existing | queued |
