...
1. Click the alignment track in the sidebar. The alignment viewport opens and the Inspector, the panel down the right-hand side of the window, switches to its Bundle tab and fills with the alignment summary. If the Inspector is not showing, open it with **View > Show Inspector** (Cmd-Option-I). <!-- SHOT: inspector-alignment-stats -->
