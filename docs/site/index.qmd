...
The [user manual](https://lungfish-genome-explorer.readthedocs.io/en/latest/) on Read the Docs is the place for step-by-step guidance. It is being written alongside the app, so expect gaps. The [README](https://github.com/dhoconno/lungfish-genome-explorer#what-lge-can-do-today) has a current, viewport-by-viewport account of what the app does.
