...
The [user manual](https://lungfish-genome-explorer.readthedocs.io/en/latest/) on Read the Docs is the place for step-by-step guidance. It is being written alongside the app, so expect gaps.
...
Development is supported by [Inkfish](https://ink.fish).
