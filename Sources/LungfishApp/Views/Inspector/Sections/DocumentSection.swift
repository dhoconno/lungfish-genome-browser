...
public final class DocumentSectionViewModel {
    ...
    /// Updates the view model with genotype-result data and clears other document modes.
    func updateGenotypeResultDocument(_ state: GenotypeResultDocumentState?) {
        genotypeResultDocument = state
        guard state != nil else { return }
    ...
    var bundleHorizontalScrollDirection: ScrollDirectionPreference = ReferenceBundleScrollDirectionPreference.current()
...
public struct DocumentSection: View {
    ...
    public var body: some View {
        if viewModel.mappingDocument != nil {
