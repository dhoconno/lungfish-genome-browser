    ...
    internal func runStaged(
        ...
        pipelineSteps.append(FullLengthONTMHCProvenanceStep(
            ...
            resolvedOptions: [
                ...
                "exactGenomicRule": .string("zero SNP substitutions; known status requires full reference and consensus spans from target position 1 with no I/D/N/H; terminal S is allowed only when annotation topology proves the genomic reference complete"),
                "referenceCompletenessPolicy": .string(MHCReferenceCompletenessAssessment.topologyPolicyDescription),
                "partialExtensionDeferralRule": .string("a zero-SNP genomic overlap with no I/D/N and incomplete or unknown reference completeness, or incomplete consensus end coverage, is deferred from initial known calls for reciprocal partial-extension classification; a qualifying complete-aware genomic match still wins"),
                ...
                "classificationPrecedence": .array([
                    .string("complete-aware genomic known"), .string("partial extension candidate"),
